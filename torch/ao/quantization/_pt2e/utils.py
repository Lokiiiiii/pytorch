...
def _fold_bn_weights_into_conv_node(
    ...
    # bn weight
    bn_w = _get_tensor_constant_from_node(bn_node.args[1], m)
    # bn bias
    bn_b = _get_tensor_constant_from_node(bn_node.args[2], m)
    # bn running mean
    bn_rm = _get_tensor_constant_from_node(bn_node.args[3], m)
    # bn running variance
    bn_rv = _get_tensor_constant_from_node(bn_node.args[4], m)
